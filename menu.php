    ...
    <div class="container-fluid">
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <ul class="navbar-nav me-auto mb-lg-0">
          <li class="nav-item" >
            <h1 class="mb-0">
              <a class="nav-link active pb-0" aria-current="page" href="index.php">
                <img class="logo" src="themes/pictures/logo.png" alt="logo" />
              </a>
            </h1>
          </li>
        </ul>
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item contact">
            ...
            <a href="https://mastodon.tedomum.net/@anisote" rel="noopener noreferrer nofollow">
              <svg class="mastodon" version="1.1" viewbox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><g>
